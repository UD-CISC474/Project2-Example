...
export class OrderRouter {
    ...
    */
    public getRouter(): express.Router {
        this.router.get("/", [SecurityMiddleware.validateUser], this.controller.getOrders);
        this.router.get("/:orderno", [SecurityMiddleware.validateUser], this.controller.getOrder);
